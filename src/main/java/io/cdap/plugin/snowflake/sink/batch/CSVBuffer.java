...
public class CSVBuffer implements Closeable {
  ...
  public void reset() {
    ...
    try {
      ...
      String errorMessage = String.format("Unable to reset the CSV stream and recreate the printer. " +
        "This might occur due to issues with the OutputStreamWriter or the CSV format. " +
